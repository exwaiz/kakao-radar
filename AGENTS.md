...
2026-09-18 최신 지시: 주기적 KakaoTalk 깨우기 기능은 보류한다. Telegram 테스트는 10분에서 매시 정각 1시간으로 변경하며 최대 3개 주제, 기존 오늘 quota 144회, 실제 원문 인용·진도·중복 억제·AI $1/day를 보존한다. 9/19 자정의 23:00/하루 1회/최대 5개 주제 복귀는 유지한다. M2/M3/M4/WSL 및 기기 진단 기록을 master로 통합하고 Android/서버 버전 1.0.0을 표시한다. 아래 이전 테스트 주기보다 이 지시가 우선하며 릴리스 표시를 장기 수집률·사용자 품질 평가 통과로 해석하지 않는다.
